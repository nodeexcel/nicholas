                            ...
                            if (zipEntry.name) {
                                ...
                                db.products.findOne({ where: { productID: productID[0] } }).then((product) => {
                                    if (!product) {
                                        ...
                                        console.log(FinalResult.length, errors.length, zipEntries.length - 1, "jjjjjjjjjjjjjjjjjjj")
                                        console.log(FinalResult.length + errors.length, "lengthhhhhhhhhhhhhhh", zipEntries.length - 1)
